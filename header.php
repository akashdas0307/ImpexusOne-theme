...
// Header class based on width type
$header_class = 'site-header';
if ($header_width_type === 'full-width') {
    $header_class .= ' header-full-width';
} elseif ($header_width_type === 'adaptive') {
    $header_class .= ' header-adaptive';
}
?>
<!DOCTYPE html>
        ...
        <div class="header-actions">
            <?php if ($show_header_search) : ?>
                ...
                <?php else : ?>
                    ...
                    <button type="button" class="header-icon-btn" aria-label="<?php esc_attr_e('Search', 'impexusone'); ?>" id="search-toggle" data-search-type="<?php echo esc_attr($search_type); ?>">
                        <span class="material-symbols-outlined">search</span>
                    </button>
                    <?php if ($search_type === 'dropdown') : ?>
                        ...
                        <div class="search-dropdown" id="search-dropdown">
                            <form role="search" method="get" action="<?php echo esc_url(home_url('/')); ?>">
                                <input type="search" name="s" placeholder="<?php echo esc_attr($search_placeholder); ?>" aria-label="<?php esc_attr_e('Search', 'impexusone'); ?>">
                                <button type="submit" class="btn btn-primary btn-sm"><?php esc_html_e('Search', 'impexusone'); ?></button>
                            </form>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
...
<div class="search-modal" id="search-modal" role="dialog" aria-modal="true" aria-labelledby="search-modal-title">
    <button type="button" class="search-modal-close" aria-label="<?php esc_attr_e('Close search', 'impexusone'); ?>">&times;</button>
